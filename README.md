...
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v2.1%20adopted-ff69b4.svg)](docs/CODE_OF_CONDUCT.md)
[![License](https://img.shields.io/github/license/dell/dellemc-openmanage-ansible-modules)](LICENSE)
...
## Supported Platforms
  ...
  * iDRAC 8 based Dell EMC PowerEdge Servers with firmware versions 2.82.82.82 and above.
  * iDRAC 9 based Dell EMC PowerEdge Servers with firmware versions 5.10.10.00 and above.
  * Dell EMC OpenManage Enterprise versions 3.8.3 and above.
  * Dell EMC OpenManage Enterprise Modular versions 1.40.10 and above.

## Prerequisites
  * [Ansible >= 2.13.0](https://github.com/ansible/ansible)
  * Python >= 3.9.6
