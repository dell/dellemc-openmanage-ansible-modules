...
class TestOmeTemplate(FakeAnsibleModule):
    ...
    sub_param1 = {"param": {"enable_ntp": True, "primary_ntp_address": "255.0.0.0", "system_time": "2020-03-31 21:35:19"}, "msg":
    ...
    sub_param3 = {"param": {"enable_ntp": False}, "msg": "enable_ntp is False but any of the following are missing: time_zone, system_time"}
    sub_param4 = {"param": {"enable_ntp": True},
                  "msg": "enable_ntp is True but any of the following are missing: time_zone, primary_ntp_address, secondary_ntp_address1, secondary_ntp_address2"}
    sub_param5 = {"param": {"enable_ntp": False, "primary_ntp_address": "10.136.112.220"}, "msg":
        "enable_ntp is False but any of the following are missing: time_zone, system_time"}
    sub_param6 = {"param": {"enable_ntp": False, "secondary_ntp_address1": "10.136.112.220", "system_time": "2020-03-31 21:35:19"}, "msg":
        "parameters are mutually exclusive: system_time|secondary_ntp_address1"}
    sub_param7 = {"param": {"enable_ntp": False, "secondary_ntp_address2": "10.136.112.220", "system_time": "2020-03-31 21:35:19"},
                  "msg": "parameters are mutually exclusive: system_time|secondary_ntp_address2"}
    sub_param8 = {"param": {"enable_ntp": False, "primary_ntp_address": "10.136.112.220", "secondary_ntp_address1": "10.136.112.220", "system_time": "2020-03-31 21:35:19"},
                  "msg": "parameters are mutually exclusive: system_time|primary_ntp_address, system_time|secondary_ntp_address1"}
    sub_param9 = {"param": {"enable_ntp": False, "system_time": "2020-03-31 21:35:19", "primary_ntp_address": "10.136.112.220", "secondary_ntp_address2": "10.136.112.220"},
                  "msg": "parameters are mutually exclusive: system_time|primary_ntp_address, system_time|secondary_ntp_address2"}
    sub_param10 = {"param": {"enable_ntp": False, "system_time": "2020-03-31 21:35:19", "primary_ntp_address": "10.136.112.220", "secondary_ntp_address2": "10.136.112.220", "secondary_ntp_address1": "10.136.112.220"},
                  "msg": "parameters are mutually exclusive: system_time|primary_ntp_address, system_time|secondary_ntp_address1, system_time|secondary_ntp_address2"}
    sub_param11 = {"param": {"enable_ntp": False, "primary_ntp_address": "255.0.0.0", "system_time": "2020-03-31 21:35:19"},
                  "msg": 'parameters are mutually exclusive: system_time|primary_ntp_address'}

    @pytest.mark.parametrize("param", [sub_param1, sub_param2, sub_param3, sub_param4, sub_param5, sub_param6, sub_param7, sub_param8,
                                       sub_param9, sub_param10, sub_param11])
    def test_ome_application_network_time_main_failure_case_01(self, mocker, ome_default_args, param, ome_connection_mock_for_application_network_time, ome_response_mock):
    ...
    def test_remove_unwanted_keys_unwanted_keys_time(self):
        ...
        current_setting = {"@odata.context":"/api/$metadata#Network.TimeConfiguration","@odata.type":"#Network.TimeConfiguration","@odata.id":"/api/ApplicationService/Network/TimeConfiguration","TimeZone":"TZ_ID_1","TimeZoneIdLinux":"Etc/GMT+12","TimeZoneIdWindows":"Dateline Standard Time",
                           "EnableNTP": False,"PrimaryNTPAddress": None,"SecondaryNTPAddress1":None,"SecondaryNTPAddress2":None,"SystemTime":"2020-03-31 21:37:08.897","TimeSource":"Local Clock","UtcTime":"2020-04-01 09:37:08.897"}
        removable_keys = ["@odata.context", "@odata.type", "@odata.id", "TimeZoneIdLinux", "TimeZoneIdWindows", "TimeSource", "UtcTime"]
        self.module.remove_unwanted_keys(removable_keys, current_setting)
        assert current_setting == {"TimeZone":"TZ_ID_1","EnableNTP":False, "PrimaryNTPAddress":None,"SecondaryNTPAddress1":None,"SecondaryNTPAddress2":None,"SystemTime":"2020-03-31 21:37:08.897"}
    ...
    def test_get_updated_payload_success_case(self, ome_default_args, ome_connection_mock_for_application_network_time, ome_response_mock):
        current_setting = {"@odata.context":"/api/$metadata#Network.TimeConfiguration","@odata.type":"#Network.TimeConfiguration","@odata.id":"/api/ApplicationService/Network/TimeConfiguration","TimeZone":"TZ_ID_02","TimeZoneIdLinux":"Asia/Colombo","TimeZoneIdWindows":"Sri Lanka Standard Time","EnableNTP":True,"PrimaryNTPAddress":"10.136.112.220","SecondaryNTPAddress1":"10.136.112.221","SecondaryNTPAddress2":"10.136.112.222","SystemTime":"2020-04-01 15:39:23.825","TimeSource":"10.136.112.222","UtcTime":"2020-04-01 10:09:23.825"}
    ...
    def test_get_updated_payload_check_mode_success_case1(self, ome_default_args, ome_connection_mock_for_application_network_time, ome_response_mock):
    ...
    def test_get_updated_payload_check_mode_success_case2(self, ome_default_args, ome_connection_mock_for_application_network_time, ome_response_mock):
        current_setting = {"@odata.context": "/api/$metadata#Network.TimeConfiguration",
                           "@odata.type": "#Network.TimeConfiguration",
                           "@odata.id": "/api/ApplicationService/Network/TimeConfiguration",
                           "TimeZone": "TZ_ID_02", "TimeZoneIdLinux":"Asia/Colombo",
    ...
    def test_get_updated_payload_check_mode_success_case3(self, ome_default_args, ome_connection_mock_for_application_network_time, ome_response_mock):
        current_setting = {"@odata.context": "/api/$metadata#Network.TimeConfiguration",
                           "@odata.type": "#Network.TimeConfiguration",
                           "@odata.id": "/api/ApplicationService/Network/TimeConfiguration",
                           "TimeZone": "TZ_ID_02", "TimeZoneIdLinux":"Asia/Colombo",
    ...
    def test_get_updated_payload_without_check_mode_success_case(self, ome_default_args, ome_connection_mock_for_application_network_time, ome_response_mock):
    ...
    def test_validate_time_zone_failure_case01(self, ome_default_args, time_zone_val, ome_response_mock, ome_connection_mock_for_application_network_time):
        ...
        ome_response_mock.json_data = {"@odata.context":"/api/$metadata#Collection(Network.TimeZone)",
                                       "@odata.count":3,
                                       "value":[{"@odata.type": "#Network.TimeZone", "Utcoffsetminutes": 60, "Id": "TZ_ID_38", "Name":
                                           "(GMT+01:00) Brussels, Copenhagen, Madrid, Paris"},
                                                {"@odata.type": "#Network.TimeZone", "Utcoffsetminutes": 60, "Id":"TZ_ID_39", "Name":
                                                    "(GMT+01:00) Sarajevo, Skopje, Warsaw, Zagreb"},
                                                {"@odata.type": "#Network.TimeZone", "Utcoffsetminutes": 360, "Id":"TZ_ID_70", "Name": "(GMT+06:00) Novosibirsk"}]}
    ...
    def test_validate_time_zone_successcase01(self, ome_default_args, ome_response_mock, ome_connection_mock_for_application_network_time):
        param = {"time_zone": "TZ_ID_38"}
        ome_default_args.update(param)
        f_module = self.get_module_mock(params=ome_default_args)
        ome_response_mock.json_data = {"@odata.context": "/api/$metadata#Collection(Network.TimeZone)",
                                       "@odata.count": 3,
                                       "value":[{"@odata.type": "#Network.TimeZone","Utcoffsetminutes": 60, "Id": "TZ_ID_38", "Name": "(GMT+01:00) Brussels, Copenhagen, Madrid, Paris"},
                                                {"@odata.type": "#Network.TimeZone","Utcoffsetminutes": 60, "Id": "TZ_ID_39", "Name": "(GMT+01:00) Sarajevo, Skopje, Warsaw, Zagreb"},
                                                {"@odata.type": "#Network.TimeZone","Utcoffsetminutes": 360, "Id": "TZ_ID_70", "Name": "(GMT+06:00) Novosibirsk"}]}
        self.module.validate_time_zone(f_module, ome_connection_mock_for_application_network_time)
        assert ome_connection_mock_for_application_network_time.invoke_request.called

    def test_validate_time_zone_successcase02(self, ome_default_args, ome_response_mock, ome_connection_mock_for_application_network_time):
    ...
    def test_validate_time_zone_successcase03(self, ome_default_args, ome_response_mock, ome_connection_mock_for_application_network_time):
