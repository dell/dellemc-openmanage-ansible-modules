...
from ansible.modules.remote_management.dellemc import ome_smart_fabric_uplink
from units.modules.remote_management.dellemc.common import FakeAnsibleModule, Constants

MODULE_PATH = 'ansible.modules.remote_management.dellemc.ome_smart_fabric_uplink.'
