...
def ome_connection_mock_for_firmware_baseline_compliance_info(mocker, ome_response_mock):
    connection_class_mock = mocker.patch(
        'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.RestOME')
...
class TestOmeFirmwareCatalog(FakeAnsibleModule):
    ...
    def test_get_device_ids_from_group_names_success_case(self, mocker, ome_response_mock,
        ...
        ome_response_mock.success = True
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_device_ids_from_group_ids',
    ...
    def test_get_identifiers_with_service_tags(self, mocker, ome_connection_mock_for_firmware_baseline_compliance_info,
        ...
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info._get_device_id_from_service_tags',
    ...
    def test_get_identifiers_with_group_names(self, mocker, ome_connection_mock_for_firmware_baseline_compliance_info,
        ...
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_device_ids_from_group_names',
    ...
    def test_get_baselines_report_by_device_ids_success_case(self, mocker,
                                                             ...
                                                             ome_response_mock):
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_identifiers',
    ...
    def test_get_baseline_compliance_reports_success_case_for_baseline_device(self, mocker, ome_response_mock,
                                                                              ome_connection_mock_for_firmware_baseline_compliance_info):
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_baseline_id_from_name',
            return_value=123)
    ...
    def test_baseline_complaince_main_success_case_01(self, mocker, ome_default_args, module_mock,
                                                      ome_connection_mock_for_firmware_baseline_compliance_info):
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.validate_inputs')
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_baselines_report_by_device_ids',
    ...
    def test_baseline_complaince_main_success_case_02(self, mocker, ome_default_args, module_mock,
        ...
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.validate_inputs')
        mocker.patch(
            'ansible.modules.remote_management.dellemc.ome_firmware_baseline_compliance_info.get_baseline_compliance_reports',
