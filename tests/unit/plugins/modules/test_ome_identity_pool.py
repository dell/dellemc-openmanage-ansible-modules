...
class TestOMeIdentityPool(FakeAnsibleModule):
    ...
    @pytest.mark.parametrize("param", [{"ethernet_settings": {"invalid_key": "value"}},
                                       ...
                                       {"iscsi_settings": {"initiator_ip_pool_settings": {"primary_dns_server": "192.168.4.1", "ip_range1": "value"}}},
    ...
    def test_compare_payload_attributes_false_case_for_dummy_pool_setting(self):
        ...
        existing_setting_payload = {"@odata.context": "/api/$metadata#IdentityPoolService.IdentityPool", "@odata.type": "#IdentityPoolService.IdentityPool",
                                    "@odata.id": "/api/IdentityPoolService/IdentityPools(33)", "Id": 33, "Name": "pool4", "Description": None,
                                    "CreatedBy": "admin", "CreationTime": "2020-01-31 14:53:18.59163", "LastUpdatedBy": "admin",
                                    "LastUpdateTime": "2020-01-31 15:22:08.34596", "EthernetSettings": None, "IscsiSettings": None, "FcoeSettings": None,
                                    "FcSettings": None, "UsageCounts": {"@odata.id": "/api/IdentityPoolService/IdentityPools(33)/UsageCounts"},
    ...
    def test_compare_payload_attributes_case_false(self, modify_payload):
        ...
        existing_setting_payload = {"@odata.context": "/api/$metadata#IdentityPoolService.IdentityPool", "@odata.type": "#IdentityPoolService.IdentityPool",
                                    ...
                                    "CreationTime": "2020-01-31 09:28:16.491424", "LastUpdatedBy": "admin", "LastUpdateTime": "2020-01-31 09:49:59.012549",
                                    "EthernetSettings": {"Mac": {"IdentityCount": 60, "StartingMacAddress": "UFBQUFAA"}}, "IscsiSettings": None,
                                    "FcoeSettings": {"Mac": {"IdentityCount": 70, "StartingMacAddress": "cHBwcHAA"}}, "FcSettings": None,
                                    "UsageCounts": {"@odata.id": "/api/IdentityPoolService/IdentityPools(23)/UsageCounts"},
    ...
    def test_compare_payload_attributes_case_true(self, modify_payload):
        ...
        existing_setting_payload = {"@odata.context": "/api/$metadata#IdentityPoolService.IdentityPool", "@odata.type": "#IdentityPoolService.IdentityPool",
                                    ...
                                    "EthernetSettings": {"Mac": {"IdentityCount": 70, "StartingMacAddress": "qrvM3e6q"}}, "IscsiSettings": None,
                                    "FcoeSettings": {"Mac": {"IdentityCount": 70, "StartingMacAddress": "cHBwcHAA"}}, "FcSettings": None,
                                    "UsageCounts": {"@odata.id": "/api/IdentityPoolService/IdentityPools(30)/UsageCounts"},
    ...
    def test_get_updated_modify_payload_case_03(self):
        ...
        existing_setting_payload = {"@odata.context": "/api/$metadata#IdentityPoolService.IdentityPool", "@odata.type": "#IdentityPoolService.IdentityPool",
                                    "@odata.id": "/api/IdentityPoolService/IdentityPools(30)", "Id": 30, "Name": "pool1",
                                    "Description": "Identity pool with ethernet setting", "CreatedBy": "admin", "CreationTime": "2020-01-31 11:31:13.621182",
                                    "LastUpdatedBy": "admin", "LastUpdateTime": "2020-01-31 11:34:28.00876", "EthernetSettings": None, "IscsiSettings": None,
                                    "FcoeSettings": None, "FcSettings": None,
                                    "UsageCounts": {"@odata.id": "/api/IdentityPoolService/IdentityPools(30)/UsageCounts"},
                                    "UsageIdentitySets@odata.navigationLink": "/api/IdentityPoolService/IdentityPools(30)/UsageIdentitySets"}
        payload = self.module.get_updated_modify_payload(payload, existing_setting_payload)
    ...
    def test_get_updated_modify_payload_case_05(self):
        ...
        existing_setting_payload = {"@odata.context": "/api/$metadata#IdentityPoolService.IdentityPool", "@odata.type": "#IdentityPoolService.IdentityPool",
                                    ...
                                    "Description": "Identity pool with ethernet setting", "CreatedBy": "admin", "CreationTime": "2020-01-31 11:31:13.621182",
                                    "LastUpdatedBy": "admin", "LastUpdateTime": "2020-01-31 11:34:28.00876",
                                    "EthernetSettings": {"Mac": {"StartingMacAddress": "qrvM3e6q"}}, "IscsiSettings": None,
    ...
    @pytest.mark.parametrize("mac_address", ['50-50-50-50-50-50', '50:50:50:50:50:50', '5050.5050.5050', 'ab:cd:ef:70:80:70', 'aabb.ccdd.7070'])
    ...
    def test_validate_modify_create_payload_failure_case1(self, payload, action, setting):
        ...
        f_module = self.get_module_mock()
        msg = "Both starting MAC address and identity count is required to {0} an identity pool using {1} settings.".format(action, ''.join(setting.split('Settings')))
        with pytest.raises(Exception, match=msg) as exc:
    ...
    @pytest.mark.parametrize("action", ["create", "modify"])
    @pytest.mark.parametrize("modify_payload", [modify_fc_setting1, modify_fc_setting2, modify_fc_setting3, modify_fc_setting4, modify_fc_setting5])
    def test_validate_modify_create_payload_failure_fc_setting_case(self, modify_payload, action):
        ...
        f_module = self.get_module_mock()
        msg = "Both starting MAC address and identity count is required to {0} an identity pool using Fc settings.".format(action)
        with pytest.raises(Exception, match=msg) as exc:
            self.module.validate_modify_create_payload(modify_payload, f_module, action)
    ...
    def test_validate_modify_create_payload_failure_iscsi_setting_case1(self, modify_payload, action):
        ...
        modify_payload.update(payload)
        f_module = self.get_module_mock()
        msg = "Both starting MAC address and identity count is required to {0} an identity pool using iSCSI settings.".format(action)
        with pytest.raises(Exception, match=msg) as exc:
            self.module.validate_modify_create_payload(modify_payload, f_module, action)
    ...
    @pytest.mark.parametrize("action", ["create", "modify"])
    @pytest.mark.parametrize("initiatorconfig_payload", [payload_iscsi4, payload_iscsi5, payload_iscsi6, payload_iscsi7])
    ...
    @pytest.mark.parametrize("action", ["create", "modify"])
    @pytest.mark.parametrize("initiatorip_payload", [payload_iscsi8, payload_iscsi9, payload_iscsi10, payload_iscsi11, payload_iscsi12])
