...
class TestOmeTemplateNetworkVlan(FakeAnsibleModule):
    ...
    def test_main_ome_template_network_vlan_success_case1(self, mocker, ome_default_args,
                                                          ...
                                                          ome_response_mock):
        sub_param = {"nic_identifier": "NIC1", "tagged_networks": [
    ...
    @pytest.mark.parametrize("params",
                             [{"success": True, "json_data": {"value": [{"Name": "template_name", "Id": 123}]}, "id": 123},
                ...
                "SubAttributeGroups": [{
                    ...
                    "SubAttributeGroups": [{
                        "GroupNameId": 1, "SubAttributeGroups": [{"GroupNameId": 1, "DisplayName": "Partition",
                                                                  "SubAttributeGroups": [],
                                                                  "Attributes": [
                                                                      {"CustomId": 2302, "DisplayName": "Vlan Tagged",
                                                                       "Value": "12765, 12767, 12768"},
                                                                      {"CustomId": 2302, "DisplayName": "Vlan UnTagged",
                                                                       "Value": "12766"}]}],
                        "Attributes": []},
