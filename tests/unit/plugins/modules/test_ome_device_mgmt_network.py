...
class TestOmeDeviceMgmtNetwork(FakeAnsibleModule):
    ...
    @pytest.mark.parametrize("param", [{"in": inp_param, "device": chassis, "enable_nic": False, "delay": 5,
                                       ...
                                       {"in": inp_param, "device": chassis, "enable_nic": True,
                                        "diff": {'StaticAlternateDNSServer': '2607:f2b1:f081:9:1c8c:f1c7:47e:f121',
                                                 ...
                                                 'StaticGateway': '0000::ffff', 'StaticSubnetMask': 'XXX.XXX.XXX.XXX',
                                       ...
                                       {"in": {"ipv4_configuration": ipv4_configuration}, "device": chassis,
                                        "enable_nic": True,
                                        "diff": {'StaticAlternateDNSServer': 'ZY.ZY.ZY.ZY',
                                                 'StaticPreferredDNSServer': 'ZZ.ZZ.ZZ.ZZ',
                                                 'StaticGateway': 'YY.YY.YY.YY', 'StaticSubnetMask': 'XXX.XXX.XXX.XXX',
                                                 'StaticIPAddress': 'XX.XX.XX.XX'}},
    ...
    @pytest.mark.parametrize("param", [{"in": inp_param, "device": server, "enable_nic": False,
                                       ...
                                       {"in": inp_param, "device": server, "enable_nic": True,
                                        "diff": {'staticIPAddressIPv4': 'XX.XX.XX.XX',
                                                 'staticSubnetMaskIPv4': 'XXX.XXX.XXX.XXX',
                                                 'staticGatewayIPv4': 'YY.YY.YY.YY',
                                                 'staticPreferredDNSIPv4': 'ZZ.ZZ.ZZ.ZZ',
                                                 'staticAlternateDNSIPv4': 'ZY.ZY.ZY.ZY',
                                       ...
                                       {"in": {"ipv4_configuration": ipv4_configuration}, "device": server,
                                        "enable_nic": True, "diff": {'staticIPAddressIPv4': 'XX.XX.XX.XX',
                                                                     'staticSubnetMaskIPv4': 'XXX.XXX.XXX.XXX',
                                                                     'staticGatewayIPv4': 'YY.YY.YY.YY',
                                                                     'staticPreferredDNSIPv4': 'ZZ.ZZ.ZZ.ZZ',
                                                                     'staticAlternateDNSIPv4': 'ZY.ZY.ZY.ZY'}},
    ...
    @pytest.mark.parametrize("param", [{"in": inp_param, "device": iom, "enable_nic": False,
                                        "diff": {'StaticGateway': '0000::ffff', 'StaticIPAddress': 'XX.XX.XX.XX',
                                                 'StaticSubnetMask': 'XXX.XXX.XXX.XXX', 'EnableDHCP': False,
                                       ...
                                       {"in": {"ipv4_configuration": ipv4_configuration}, "device": iom,
                                        "enable_nic": True,
                                        "diff": {'StaticGateway': 'YY.YY.YY.YY', 'StaticIPAddress': 'XX.XX.XX.XX',
                                                 'StaticSubnetMask': 'XXX.XXX.XXX.XXX', 'EnableDHCP': False}},
