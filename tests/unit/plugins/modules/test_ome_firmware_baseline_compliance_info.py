...
class TestOmeFirmwareCatalog(FakeAnsibleModule):
    ...
    def test__get_device_id_from_service_tags_for_baseline_success_case(self, ome_response_mock, ome_connection_mock_for_firmware_baseline_compliance_info):
        ...
        data = self.module._get_device_id_from_service_tags([Constants.service_tag1], ome_connection_mock_for_firmware_baseline_compliance_info, f_module)
        assert data == {Constants.device_id1:Constants.service_tag1}

    def test__get_device_id_from_service_tags_empty_case(self, ome_response_mock, ome_connection_mock_for_firmware_baseline_compliance_info):
    ...
    def test_get_device_id_from_service_tags_for_baseline_error_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ...
        with pytest.raises(HTTPError) as ex:
            self.module._get_device_id_from_service_tags(["INVALID"], ome_connection_mock_for_firmware_baseline_compliance_info, f_module)

    def test_get_device_id_from_service_tags_for_baseline_value_error_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_response_mock.json_data = {"value": [{"DeviceServiceTag": Constants.service_tag1, "Id": Constants.device_id1}]}
        ome_response_mock.status_code = 500
        ome_response_mock.success = False
        f_module = self.get_module_mock()
        with pytest.raises(Exception) as exc:
            self.module._get_device_id_from_service_tags(["#$%^&"], ome_connection_mock_for_firmware_baseline_compliance_info, f_module)
        assert exc.value.args[0] == "Failed to fetch the device information."

    def test_get_device_ids_from_group_ids_success_case(self, ome_response_mock, ome_connection_mock_for_firmware_baseline_compliance_info):
        ome_response_mock.json_data = {"value": [{"DeviceServiceTag": Constants.service_tag1, "Id": Constants.device_id1}]}
        ome_response_mock.status_code = 200
        ome_response_mock.success = True
        f_module = self.get_module_mock()
        device_ids = self.module.get_device_ids_from_group_ids(f_module, ["123", "345"], ome_connection_mock_for_firmware_baseline_compliance_info)
        assert device_ids == [Constants.device_id1, Constants.device_id1]

    def test_get_device_ids_from_group_ids_empty_case(self, ome_response_mock, ome_connection_mock_for_firmware_baseline_compliance_info):
        ome_response_mock.json_data= {"value": []}
        ome_response_mock.status_code = 200
        ome_response_mock.success = True
        f_module = self.get_module_mock()
    ...
    def test_get_device_ids_from_group_ids_error_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_connection_mock_for_firmware_baseline_compliance_info.invoke_request.side_effect = HTTPError('http://testhost.com', 400, '', {}, None)
        ome_response_mock.status_code = 200
        ome_response_mock.success = True
        f_module = self.get_module_mock()
        with pytest.raises(HTTPError) as ex:
            device_ids = self.module.get_device_ids_from_group_ids(f_module, ["123456"], ome_connection_mock_for_firmware_baseline_compliance_info)

    def test_get_device_ids_from_group_ids_value_error_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_response_mock.status_code = 500
        ome_response_mock.success = False
        f_module = self.get_module_mock()
        with pytest.raises(Exception) as exc:
    ...
    def test_get_device_ids_from_group_names_empty_case(self, mocker, ome_response_mock, ome_connection_mock_for_firmware_baseline_compliance_info):
        ome_response_mock.json_data= {"value": []}
        ome_response_mock.status_code = 200
        ome_response_mock.success = True
        mocker.patch('ansible_collections.dellemc.openmanage.plugins.modules.ome_firmware_baseline_compliance_info.get_device_ids_from_group_ids',
    ...
    def test_get_device_ids_from_group_names_error_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_connection_mock_for_firmware_baseline_compliance_info.invoke_request.side_effect = HTTPError('http://testhost.com', 400, '', {}, None)
        ome_response_mock.status_code = 200
        ome_response_mock.success = True
        f_module = self.get_module_mock(params={"device_group_names": ["abc", "xyz"]})
    ...
    def test_get_baseline_id_from_name_success_case(self, default_ome_args, ome_connection_mock_for_firmware_baseline_compliance_info, module_mock, ome_response_mock):
        ...
        ome_response_mock.json_data = {"value": [{"Name": "baseline_name1", "Id": 111}, {"Name": "baseline_name2",
                                                                                         "Id": 222}]}
        baseline_id = self.module.get_baseline_id_from_name(ome_connection_mock_for_firmware_baseline_compliance_info, f_module)
        assert baseline_id == 111

    def test_get_baseline_id_from_name_when_name_not_exists(self, default_ome_args, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_response_mock.success = True
    ...
    def test_get_baseline_id_from_name_when_baselinename_is_none(self, default_ome_args, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_response_mock.success = True
        ome_response_mock.json_data = {"value": []}
    ...
    def test_get_baseline_id_from_name_with_http_error_handlin_case(self, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
        ome_connection_mock_for_firmware_baseline_compliance_info.invoke_request.side_effect = HTTPError('http://testhost.com', 400, '', {}, None)
    ...
    def test_get_baselines_report_by_device_ids_exception_handling(self,exc_type, ome_connection_mock_for_firmware_baseline_compliance_info, ome_response_mock):
